...
| 기업 | 주요 직무 | 한국인 비율 | 평균 연봉 |
|------|-----------|-------------|-----------|
| **Google** | 데이터 사이언티스트, PM | 3-5% | $120K-200K |
| **Amazon** | 공급망 최적화, 비즈니스 애널리스트 | 5-8% | $110K-180K |
| **Microsoft** | 프로그램 매니저, Azure PM | 4-6% | $130K-190K |
| **Tesla** | 생산 엔지니어, 품질 관리 | 8-12% | $90K-150K |
| **McKinsey** | 경영 컨설턴트 | 2-4% | $130K-180K |

#### ✨ 성공 사례: Google 데이터 사이언티스트
**배경**: 서울대 산업공학과 → KAIST 대학원 → Google 마운틴뷰
> *"산업공학에서 배운 통계학과 실험계획법이 A/B 테스트와 데이터 분석에서 정말 큰 도움이 됐습니다. 특히 사용자 행동 분석과 최적화에서 IE 백그라운드가 다른 전공자들과 차별화를 만들어냈어요."*

#### 🌟 성공 사례: Amazon SCM 엔지니어  
**배경**: 한양대 산업공학과 → 아마존 시애틀
> *"산업공학의 핵심인 OR(운영연구)과 SCM이 아마존의 물류 최적화와 완벽하게 매치됩니다. 캐마존(아마존 캐나다)을 통해 미국 본사로 이직하는 경로가 일반적이에요."*
